...
public class RegistroHospede extends JFrame {
	...
	public RegistroHospede() {
		...
		txtNacionalidade.setModel(new DefaultComboBoxModel<>(new String[] {"Selecione", "Brasil", "Argentina", "Chile", "Colombia", "Espanha", "Estados Unidos", "França", "Itália", "Japão", "México", "Portugal", "Uruguai"}));
